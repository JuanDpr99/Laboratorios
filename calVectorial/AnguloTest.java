...
public class AnguloTest
{
    ...
    public void deberiaCrearBienLosAngulo() {
        ...
        assertFalse (a360.equals(a0));
        assertFalse (a0.equals(a720));        
        assertFalse (a720.equals(a0));
        assertFalse (aPI.equals(a180));
        assertFalse (a180.equals(aPI));
        assertFalse (gon100.equals(a90));
        assertFalse (a90.equals(gon100));
        assertFalse (gon400.equals(a0));
        assertFalse (a0.equals(gon400));
    ...
    public void deberiaDarElValorEnGradianes() 
    {
        ...
        assertEquals(0.0, a720.gradianes(),Angulo.MAXERROR);    //<assertEquals(100, a90.gradianes(),Angulo.MAXERROR);
